...
RECORD_FILE = "insert_system3_rack1(@1).json"
recorded_sequence = {}
import traceback
import inspect
...
def insert_rack1():
    ...
    move_to_cartesian([-2,222.8,301.8,-123.8,0.7,-0.9],speed=95)
    move_to_cartesian([-221.4,30.7,301.4,-123.9,0.7,80.8],speed=60)
    move_to_cartesian([-241.5,1.5,102.4,-84.3,0.3,-1.1],speed=50)
    move_to_cartesian([-241.5,37.9,98.9,-84.3,0.3,-1.1],speed=50)
    move_to_cartesian([-241.5,37.9,94.9,-84.3,0.3,-1.1],speed=50)
...
def main():
    recorded_sequence["current"] = []  
    step_data = {}
    step_data["insert_system3_rack1"] = insert_rack1()
