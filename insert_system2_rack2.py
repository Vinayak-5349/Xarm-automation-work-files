...
RECORD_FILE = "RECORDED_ACTIONS_INSERT12.json"
recorded_sequence = {}
import traceback
import inspect
...
def insert_rack1():
    ...
    # Pickup start
    move_to_cartesian([111.6,619.9,63.4,17.6,0.7,175], speed=95)  
    open_gripper()
    timed_sleep(0.5)

    move_to_cartesian([112.8,639.4,134.4,17.6,0.7,175], speed=55)  
    # timed_sleep(1)
    ...
    move_to_cartesian([111.6,616.9,63.4,17.6,0.7,175], speed=95)  
    # timed_sleep(0.5)
    # move_to_cartesian([59,608.9,-6.4,6.7,1,173.1], speed=95)  
    # timed_sleep(0.5)
    # Move towards insert path
    move_to_cartesian([124.3,617.3,-132.2,12.1,-3,177.2], speed=95)  

    # # Insert path
    move_to_cartesian([242.9,426.9,-209.3,26.2,-23.9,104.6], speed=95)  
    # move_to_cartesian([280.8,374.2,-101.4,69.7,-102,177.8], speed=75)    
    ...
    move_along_tool_z(30)
    timed_sleep(5)
    move_along_tool_z(-30)

    move_to_cartesian([284.6,339.5,56.7,69.7,1.2,175],speed=50)
    move_to_cartesian([284.9,341.6,51.1,69.7,1.2,175],speed=50)   
    move_to_cartesian([283.2,307.4,39.8,69.7,1.2,175], speed=50) 
    move_to_cartesian([242.9,426.9,-209.3,26.2,-23.9,104.6], speed=50)
    move_to_cartesian([124.3,617.3,-132.2,12.1,-3,177.2], speed=55) 
    move_to_cartesian([111.6,616.9,63.4,17.6,0.7,175], speed=50)  
    move_to_cartesian([112.8,639.4,134.4,17.6,0.7,175], speed=55)
    open_gripper()
    timed_sleep(1)
    move_to_cartesian([111.6,616.9,63.4,17.6,0.7,175], speed=95) 
    ...
    # # Insert final steps
    # move_to_cartesian([286.3,340.7,46.6,68.4,0,175.7], speed=25)          
    # move_to_cartesian([286.3,340.7,51.9,68.4,0,175.7], speed=25)          
    # move_to_cartesian([286.3,340.1,53,68.4,0,175.7], speed=5)            
    # timed_sleep(2)
    # move_to_cartesian([286.3,356.6,56.7,68.4,0,175.7],speed=5) 
    # move_to_cartesian([286.3,378.1,66.1,68.4,0,175.4],speed=3) 
    # timed_sleep(5)
    ...
    # move_to_cartesian([286.3,306.9,40.5,69.7,3.7,176], speed=60)         
    # move_to_cartesian([280.8,374.2,-101.4,69.7,-102,177.8], speed=75)    
    # move_to_cartesian([242.9,426.9,-209.3,26.2,-23.9,104.6], speed=75)   
    ...
    # move_to_cartesian([108.5,641.4,68.3,15.8,-2.3,174.7], speed=70)  
    # close_gripper()
    # timed_sleep(1.5)
