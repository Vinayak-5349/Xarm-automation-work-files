...
RECORD_FILE = "tap_system1_rack2.json"
recorded_sequence = {}
import traceback
import inspect
...
def tap_rack2():
    ...
    move_to_cartesian([55.6,343,120.7,-143.5,-0.8,0.9],speed=75)
    open_gripper()
    timed_sleep(0.5)
    move_to_cartesian([55.8,394.9,50.5,-143.5,-0.8,0.9],speed=25)  
    close_gripper()
    timed_sleep(0.5)
    move_to_cartesian([55.6,343,120.7,-143.5,-0.8,0.9],speed=75)
    move_to_cartesian([-31.1,256.7,194.1,-140.8,2.1,-0.3],speed=95)  

    move_to_cartesian([-204.7,268.6,196.8,97.8,1.6,-89.7],speed=75)
    move_to_cartesian([-385,165.8,248.2,114.8,-1.4,-87.2],speed=75)
    move_to_cartesian([-345,165.8,155.6,114.8,-1.4,-87.2],speed=75)
    # # # Tapping
    # # move_to_cartesian([-365.5,159.4,134.4,126.6,-0.8,-89.2],speed=25)
   
    move_to_cartesian([-355.2,165.1,135.5,126.9,-0.9,-87.9],speed=25)
    timed_sleep(7)
    # # # going back
    move_to_cartesian([-385,165.8,248.2,114.8,-1.4,-87.2],speed=75)
    move_to_cartesian([-345,165.8,227.2,97.2,-0.5,-86.9],speed=75)
    move_to_cartesian([-204.7,268.6,196.8,97.8,1.6,-89.7],speed=75)
...
def main():
    recorded_sequence["current"] = []  
    step_data = {}
    step_data["insert_system1_rack2"] = tap_rack2()
