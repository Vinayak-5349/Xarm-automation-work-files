...
RECORD_FILE = "insert_system2_rack2(1).json"
recorded_sequence = {}
import traceback
import inspect
...
def insert_rack1():
    ...
    # Pickup start
    move_to_cartesian([115.5,654.4,54.9,16.6,0.7,175], speed=95)  
    open_gripper()
    timed_sleep(0.5)

    move_to_cartesian([117.2,686.9,149.9,14.6,0.7,175], speed=95)  
    close_gripper()
    timed_sleep(0.5)
...
def main():
    recorded_sequence["current"] = []  
    step_data = {}
    step_data["insert_system1_rack2"] = insert_rack1()
